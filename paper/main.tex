...
PhaseBreak demonstrates that LPPLS analysis extends beyond financial markets to geological spectral data, with preliminary evidence of universal phase transition signatures. The Doomsday survival model offers a novel approach to fraud scheme lifetime prediction. Multi-window fitting and HMM gating improve reliability of bubble detection. Key limitations---synthetic fraud data, absence of geological ground truth events, and small sample sizes for universality testing---are explicitly acknowledged and targeted for future work. All code, tests, and data pipelines are publicly available.\footnote{\url{https://github.com/sergeeey/PhaseBreak-2026}}
